...
#First try was UUUlUUU, missing the exactly point. 
#Then it looked like I needed to give 7 digits in the URL.  
#Tried 'l', got the next hint.

text_block = '''kAewtloYgcFQaJNhHVGxXDiQmzjfcpYbzxlWrVcqsmUbCunkfxZWDZjUZMiGqhRRiUvGmYmvnJIHEmbT
...
for character in range(len(text_block)):
    if text_block[character].isupper():
        if text_block[character - 1].islower():    
            if text_block[character + 1].isupper():
                if text_block[character + 2].isupper():
                    if text_block[character + 3].islower():
                        if text_block[character + 4].isupper():
                            if text_block[character + 5].isupper():
                                if text_block[character + 6].isupper():
                                    if text_block[character + 7].islower():
                                        lower_list.append(text_block[character + 3])
                                    else:
                                        continue
                                else:
                                    continue
